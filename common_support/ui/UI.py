...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.PB_weight_input = QtWidgets.QPushButton(self.widget_4)
        self.PB_weight_input.setObjectName("PB_weight_input")
        self.gridLayout_9.addWidget(self.PB_weight_input, 0, 0, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.PB_empty, 0, 1, 1, 1)
...
"}")
        ...
        self.SAWC_products.setGeometry(QtCore.QRect(0, 0, 140, 538))
        self.SAWC_products.setObjectName("SAWC_products")
        self.gridLayout_14 = QtWidgets.QGridLayout(self.SAWC_products)
    ...
    def retranslateUi(self, Form):
        ...
        self.PB_setup_labels.setText(_translate("Form", "SETUP LABELS"))
